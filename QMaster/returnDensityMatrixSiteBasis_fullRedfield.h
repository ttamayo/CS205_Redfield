#ifndef returnDensityMatrixSiteBasis_fullRedfield_FULLREDFIELD_H
#define returnDensityMatrixSiteBasis_fullRedfield_FULLREDFIELD_H


#include "headers.h"

class returnDensityMatrixSiteBasis_fullRedfield: public Observable
{
public:
   System *system;
...
private:
   ...
   double *h_rhoEntries;
public:
   returnDensityMatrixSiteBasis_fullRedfield(System &INsystem,OpenCL_Init INOpenCLinfo, int INt_mod, int INNsteps);
   void execute(double time, int it,  cl_mem d_sigma_System);
};

returnDensityMatrixSiteBasis_fullRedfield::returnDensityMatrixSiteBasis_fullRedfield(System &INsystem, OpenCL_Init INOpenCLinfo,int INt_mod, int INNsteps) :
...
void returnDensityMatrixSiteBasis_fullRedfield::execute(double time, int it,  cl_mem d_sigma_System)
{
   if(it%t_mod==0)
   {
      Ndata+=1;
