#ifndef LiouvilleHPulseRedfield_REDFIELD_H
#define LiouvilleHPulseRedfield_REDFIELD_H


#include "headers.h"


class LiouvilleHPulseRedfield: public LiouvilleTime
{
public:
   System *system;
...
private:
   int Nsites;
public:
   LiouvilleHPulseRedfield(System &INsystem, OpenCL_Init &INOpenCLinfo, int INNtuples, double INsigma_pulse, double INcenter_pulse, double INstrength_pulse, double INomega_pulse); /// FIXME add Pulse Parameter
...
LiouvilleHPulseRedfield::LiouvilleHPulseRedfield(System &INsystem,  OpenCL_Init &INOpenCLinfo, int INNtuples, double INsigma_pulse, double INcenter_pulse, double INstrength_pulse, double INomega_pulse) :
   system(&INsystem),
...
double_complex LiouvilleHPulseRedfield::electricField(double time) // pulse strength in cm^1
{
...
void LiouvilleHPulseRedfield::execute(cl_myreal2* INsigmaold, cl_myreal2* INsigmanew, myreal dt, myreal time)
{
...
/// INtime is in units of s,  H(t)=E(t)*mu
   ...
   // transform to exction basis
   system->convertEigenbasis(&help);
...
void LiouvilleHPulseRedfield::freeDeviceMemory()
{
