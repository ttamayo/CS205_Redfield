...
//	#pragma acc data copy(rho_real[0:SIZE*SIZE], rho_imag[0:SIZE*SIZE]) present_or_copyin(links_to_loss[0:SIZE], links_to_target[0:SIZE], D[0:SIZE], A[0:SIZE*SIZE], gammas[0:SIZE*SIZE*SIZE], all_Vs[0:SIZE*SIZE*SIZE*3]) present_or_copyin(k1_real[0:SIZE*SIZE], k1_imag[0:SIZE*SIZE], k2_real[0:SIZE*SIZE], k2_imag[0:SIZE*SIZE], k3_real[0:SIZE*SIZE], k3_imag[0:SIZE*SIZE], k4_real[0:SIZE*SIZE], k4_imag[0:SIZE*SIZE], h1_real[0:SIZE*SIZE], h1_imag[0:SIZE*SIZE]) copy(comm_real[0:SIZE*SIZE], comm_imag[0:SIZE*SIZE], lindblad_real[0:SIZE*SIZE], lindblad_imag[0:SIZE*SIZE]) 

//	#pragma acc data copy(rho_real[0:SIZE*SIZE], rho_imag[0:SIZE*SIZE]) create(k1_real[0:SIZE*SIZE], k1_imag[0:SIZE*SIZE], k2_real[0:SIZE*SIZE], k2_imag[0:SIZE*SIZE], k3_real[0:SIZE*SIZE], k3_imag[0:SIZE*SIZE], k4_real[0:SIZE*SIZE], k4_imag[0:SIZE*SIZE], h1_real[0:SIZE*SIZE], h1_imag[0:SIZE*SIZE]) copyin(D[0:SIZE], all_Vs[0:3*SIZE*SIZE*SIZE], links_to_loss[0:SIZE], links_to_target[0:SIZE], gammas[0:SIZE*SIZE*SIZE])
	for (step = 0; step < number_of_steps; step++){
		...
		print_matrix_real(h1_real, SIZE);
		print_matrix_real(h1_imag, SIZE);
