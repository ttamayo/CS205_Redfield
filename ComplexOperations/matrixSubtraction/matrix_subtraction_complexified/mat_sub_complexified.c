/*
 * C program for matrix subtraction: A - B = C
...
// Helper Function: Subtraction operation on real valued matrices
// (original author: flo)
...
// Matrix subtraction: treating real and imaginary components separately
void matrix_sub_complexified(double *A_real, double *A_imag, double *B_real, double *B_imag, double *C_real, double *C_imag, int N) {

    // Add real and imaginary parts 
    matrix_sub_real(A_real, B_real, C_real, N);
    matrix_sub_real(A_imag, B_imag, C_imag, N);
}
...
int main() {
    ...
    matrix_sub_complexified(AA_real, AA_imag, BB_real, BB_imag, CC_real, CC_imag, SIZE);
